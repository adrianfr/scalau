/*
 * DO NOT MODIFY THIS FILE. It is code-generated from config/UnitsDef_SI.txt
 */
...
object Units_SI {
	...
	class Length(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_m"
		val mainUnit = "_m"
		val allUnits = Map[String, Double]("_m" -> 1.0, "_km" -> 1000.0, "_mm" -> 0.0010)
	...
	class Mass(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_kg"
		val mainUnit = "_kg"
		val allUnits = Map[String, Double]("_kg" -> 1.0, "_tonne" -> 1000.0, "_gram" -> 0.0010)
		def _kg = new Mass(x * 1.0)
		def _tonne = new Mass(x * 1000.0)
		def _gram = new Mass(x * 0.0010)
	}
	...
	class ChemicalAmount(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_mol"
		val mainUnit = "_mol"
		val allUnits = Map[String, Double]("_mol" -> 1.0)
	...
	class Power(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val mainUnit = "_W"
		val allUnits = Map[String, Double]("_W" -> 1.0, "_J__s" -> 1.0, "_V_A" -> 1.0, "_kW" -> 1000.0)
