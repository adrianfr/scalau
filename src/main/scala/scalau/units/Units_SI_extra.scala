/*
 * DO NOT MODIFY THIS FILE. It is code-generated from config/UnitsDef_SI_extra.txt
 */
package scalau.units

import scalau._

object Units_SI_extra {
	...
	class Length(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_m"
		val mainUnit = "_m"
		val allUnits = Map[String, Double]("_m" -> 1.0, "_in" -> 0.0254, "_ft" -> 0.3048, "_km" -> 1000.0, "_mi" -> 1609.344, "_mm" -> 0.0010)
		def _m = new Length(x * 1.0)
		def _in = new Length(x * 0.0254)
		def _ft = new Length(x * 0.3048)
		def _km = new Length(x * 1000.0)
		def _mi = new Length(x * 1609.344)
		def _mm = new Length(x * 0.0010)
	}
	...
	class Mass(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_kg"
		val mainUnit = "_kg"
		val allUnits = Map[String, Double]("_kg" -> 1.0, "lb" -> 0.45359237, "gram" -> 0.0010)
		def _kg = new Mass(x * 1.0)
		def lb = new Mass(x * 0.45359237)
		def gram = new Mass(x * 0.0010)
	}
	...
	class Temperature(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		type Impl = Temperature
		def build(x:Double) = new Temperature(x)
		val baseUnits = "_K"
		val mainUnit = "_K"
		val allUnits = Map[String, Double]("_K" -> 1.0)
		def _K = new Temperature(x * 1.0)
	}

	class LumInstensity(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		type Impl = LumInstensity
		def build(x:Double) = new LumInstensity(x)
		val baseUnits = "_cd"
		val mainUnit = "_cd"
		val allUnits = Map[String, Double]("_cd" -> 1.0)
		def _cd = new LumInstensity(x * 1.0)
	}

	class ChemicalAmount(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		type Impl = ChemicalAmount
		def build(x:Double) = new ChemicalAmount(x)
		val baseUnits = "_mol"
		val mainUnit = "_mol"
		val allUnits = Map[String, Double]("_mol" -> 1.0, "_lbmol" -> 453.59237)
		def _mol = new ChemicalAmount(x * 1.0)
		def _lbmol = new ChemicalAmount(x * 453.59237)
	}
	...
	class Energy(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val mainUnit = "_J"
		val allUnits = Map[String, Double]("_N_m" -> 1.0, "_C_V" -> 1.0, "_Toe" -> 4.1868E10, "_J" -> 1.0, "_kWh" -> 3600000.0, "_W_s" -> 1.0)
		def _N_m = new Energy(x * 1.0)
		def _C_V = new Energy(x * 1.0)
		def _Toe = new Energy(x * 4.1868E10)
	...
	class LuminousFlux(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		type Impl = LuminousFlux
		def build(x:Double) = new LuminousFlux(x)
		val baseUnits = "_cd"
		val mainUnit = "_lm"
		val allUnits = Map[String, Double]("_lm" -> 1.0, "_cd_sr" -> 1.0)
		def _lm = new LuminousFlux(x * 1.0)
		def _cd_sr = new LuminousFlux(x * 1.0)
	}

	class Illuminance(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		type Impl = Illuminance
		def build(x:Double) = new Illuminance(x)
		val baseUnits = "__m2_cd"
		val mainUnit = "_lx"
		val allUnits = Map[String, Double]("_lx" -> 1.0, "_lm__m2" -> 1.0)
		def _lx = new Illuminance(x * 1.0)
		def _lm__m2 = new Illuminance(x * 1.0)
	}
	...
	class CatalyticActivity(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		type Impl = CatalyticActivity
		def build(x:Double) = new CatalyticActivity(x)
		val baseUnits = "_mol__s"
		val mainUnit = "_kat"
		val allUnits = Map[String, Double]("_kat" -> 1.0)
		def _kat = new CatalyticActivity(x * 1.0)
	}
	...
	class Area(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_m2"
		val mainUnit = "_m2"
		val allUnits = Map[String, Double]("_m2" -> 1.0)
	...
	class Volume(x:Double) extends Quantity(x) with Addable with Multipliable with Comparable {
		...
		val baseUnits = "_m3"
		val mainUnit = "_m3"
		val allUnits = Map[String, Double]("_m3" -> 1.0)
	...
	implicit def doubleToLuminousFlux(x: Double) = new LuminousFlux(x)
	implicit def doubleToIlluminance(x: Double) = new Illuminance(x)
	...
	implicit def doubleToCatalyticActivity(x: Double) = new CatalyticActivity(x)
